...
func printUsage(w io.Writer) {
	...
	fmt.Fprintf(w, "  -p, --provider    Backend: whisper, parakeet, transcribe, openai,\n")
	fmt.Fprintf(w, "                    elevenlabs, deepgram (default: whisper)\n")
	...
	fmt.Fprintf(w, "      --download    Download a whisper model and exit\n")
	fmt.Fprintf(w, "  -h, --help        Show this help message\n\n")

	fmt.Fprintf(w, "Local backends:\n")
	...
	fmt.Fprintf(w, "  transcribe  transcribe.cpp (parakeet, canary, whisper, moonshine, ...)\n")
	...
	fmt.Fprintf(w, "  golisten --download base.en\n")
